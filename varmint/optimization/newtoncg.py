    ...
    def optfun(x0, args):
        ...
        def loop_body(val):
            ...
            val = jax.lax.while_loop(
                cg_cond, cg_iteration, (False, 0, x_k, z_i, r_i, d_i, riri_0))
            print(
                f'finished cg loop with term: {val[0]} i: {val[1]} x_k: {x_k}')
