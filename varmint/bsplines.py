...
def compare_1d_basis_deriv_times():
    ...
    def version1(): return bspline1d_basis_derivs_hand(u, knots, degree)
    def version2(): return bspline1d_basis_derivs_jax(u, knots, degree)
...
def compare_1d_deriv_times():
    ...
    def version1(): return bspline1d_derivs_hand(u, control, knots, degree)
    def version2(): return bspline1d_derivs_jax(u, control, knots, degree)
...
def compare_1d_deriv_ctrl_times():
    ...
    def version1(): return bspline1d_derivs_ctrl_hand(u, control, knots, degree)
    def version2(): return bspline1d_derivs_ctrl_jax(u, control, knots, degree)
...
def compare_2d_basis_deriv_times():
    ...
    def version1(): return bspline2d_basis_derivs_hand(u, xknots, yknots, degree)
    def version2(): return bspline2d_basis_derivs_jax(u, xknots, yknots, degree)
...
def compare_2d_deriv_times():
    ...
    def version1(): return bspline2d_derivs_hand(u, control, xknots, yknots, degree)
    def version2(): return bspline2d_derivs_jax(u, control, xknots, yknots, degree)
...
def compare_2d_deriv_ctrl_times():
    ...
    def version1(): return bspline2d_derivs_ctrl_hand(
        u, control, xknots, yknots, degree)

    def version2(): return bspline2d_derivs_ctrl_jax(
        u, control, xknots, yknots, degree)
