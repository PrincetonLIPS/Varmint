...
class TestBSplines(ut.TestCase):
    ...
    def test_bspline2d_basis_values_2(self):
        ...
        degree = 1
        xknots = np.array([0.0, 0.0, 0.5, 1.0, 1.0]
                          )             # 3 control pts
        yknots = np.array([0.0, 0.0, 0.25, 0.5, 0.75,
                          1.0, 1.0])  # 5 control pts
    ...
    def test_bspline2d_values_2(self):
        ...
        yknots = np.array([0.0, 0.0, 0.25, 0.50, 0.75,
                          1.0, 1.0])  # 5 control pts
    ...
    def test_bspline3d_values_2(self):
        ...
        yknots = np.array([0.0, 0.0, 0.25, 0.50, 0.75,
                          1.0, 1.0])  # 5 control pts
        zknots = np.array([0.0, 0.0, 1./3, 2./3, 1.0, 1.0]
                          )       # 4 control pts
        xcontrol = np.arange(3)+5  # 5, 6, 7
        ycontrol = np.arange(5)+11  # 11, 12, 13, 14, 15
    ...
    def test_bspline1d_basis_derivs_1(self):
        ...
        res1 = bsplines._bspline1d_basis_derivs_hand(u, knots, degree)
        res2 = bsplines._bspline1d_basis_derivs_jax(u, knots, degree)
    ...
    def test_bspline1d_derivs_1(self):
        ...
        res1 = bsplines._bspline1d_derivs_hand(u, control, knots, degree)
        res2 = bsplines._bspline1d_derivs_jax(u, control, knots, degree)
    ...
    def test_bspline1d_derivs_ctrl(self):
        ...
        res1 = bsplines._bspline1d_derivs_ctrl_hand(u, control, knots, degree)
        res2 = bsplines._bspline1d_derivs_ctrl_jax(u, control, knots, degree)

        nptest.assert_array_almost_equal(res1, res2, decimal=4)

    def test_bspline1d_derivs_ctrl_2d(self):
        # Compare to the JAX version.
        # Currently disabled. Enable to test if implemented in the future.
    ...
    def test_bspline2d_basis_derivs_1(self):
        ...
        res1 = bsplines._bspline2d_basis_derivs_hand(u, xknots, yknots, degree)
        res2 = bsplines._bspline2d_basis_derivs_jax(u, xknots, yknots, degree)
    ...
    def test_bspline2d_derivs_1(self):
        ...
        res1 = bsplines._bspline2d_derivs_hand(
            u, control, xknots, yknots, degree)
        res2 = bsplines._bspline2d_derivs_jax(
            u, control, xknots, yknots, degree)
    ...
    def test_bspline2d_derivs_ctrl(self):
        ...
        res1 = bsplines._bspline2d_derivs_ctrl_hand(
            u, control, xknots, yknots, degree)
        res2 = bsplines._bspline2d_derivs_ctrl_jax(
            u, control, xknots, yknots, degree)
