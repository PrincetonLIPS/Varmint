...
# Geometry parameters.
parser.add_argument('-x', '--nx', type=int, default=30)
...
if __name__ == '__main__':
  ...
  def simulate(ref_ctrl):
    ...
    #  if i % 100 == 0:
    #    print('100 gradient descent iterations')
    #    print(f'loss: {loss_q(new_q)}')
    #  direction = -lr * grad_q(new_q)
    #  new_q = new_q + direction
    #end_t = time.time()
    #print(f'optimization took {end_t - start_t} seconds')
  ...
  shape.create_static_image(ctrl_sol, im_path, just_cp=True)
