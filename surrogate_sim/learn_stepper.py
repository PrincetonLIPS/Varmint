...
parser.add_argument('--nn_activation',
                    choices=['tanh', 'selu', 'relu'], default='tanh')
...
def get_residual_fun(args):
    ...
    def friction_force(q, qdot, ref_ctrl, fixed_dict): return -1e-7 * qdot
