...
def get_config() -> varmint.config_dict.ConfigDict:
    ...
    config.grid_str = "C1000 C0000 C0000 C0000 C0000 C0000 C0000 C0020\n"\
                      "C1000 C0000 C0000 C0000 C0000 C0000 C0000 C0020\n"\
                      "C1000 C0000 00000 00000 00000 00000 C0000 C0020\n"\
                      "C1000 C0000 00000 00000 00000 00000 C0000 C0020\n"\
                      "C1000 C0000 00000 00000 00000 00000 C0000 C0020\n"\
                      "C1000 C0000 00000 00000 00000 00000 C0000 C0020\n"\
                      "C1000 C0000 C0000 C0000 C0000 C0000 C0000 C0020\n"\
    ...
    config.mesh_perturb_range = [-0.2, 0.2]

    # Adjoint optimization parameters
    config.max_iter = 10000
    config.lr = 0.01
    config.geometry_lr_multiplier = 0.1
    config.freeze_radii = False
    config.freeze_nn = True
    config.freeze_nn_val = 3.0
